...
import type { IFilterSortRequest, IRowsData } from "../../grid/GridViewTypes";
        ...
        addMasterDataRecord: builder.mutation<any, IAdddMasterDataParameters>({
            ...
            async onQueryStarted(
                ...
                try {
                    ...
                    const returnPageName = (getState() as RootState)
                        .masterDataState.returnPageName;
                    const realReturnPageName = returnPageName
                        ? returnPageName
                        : "mdList";

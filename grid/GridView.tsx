...
const GridView: FC<GridViewProps> = (props) => {
  ...
  function getTableBody(keyCol: IGridColumn) {
    if (!rowsData || !rowsData.rows || rowsData.rows.length === 0) return null;
      ...
      <>
        <div className="d-flex align-items-center justify-content-center">
          <div className="form-inline">
            ...
            <select
              ...
              onChange={(e) => {
                e.preventDefault();
                const newValue = NzInt(e.target.value, curShowRowsCount);
            ...
            <input
              ...
              style={{
                width: `${
                  (Math.floor(Math.log10(rowsData.offset + 1)) + 1) * 9 + 31
                }px`,
              }}
              ...
              onChange={(e) => {
                e.preventDefault();
                const newValue = NzInt(e.target.value, rowsData.offset);
                if (onLoadRows) {
                  onLoadRows(
                    newValue,
                    curShowRowsCount,
        ...
        <div className="d-flex align-items-center justify-content-center mt-3">
          ...
          <span className="mr-1">
            ...
            {rowsData.offset + curShowRowsCount > rowsData.allRowsCount

    ...
    <Form.Group key={controlId} className="mb-1" as={Row} controlId={controlId}>
      <Col sm="8">
        <Form.Select value={curValue} onChange={handleChange}>
          <option key={YesNoFilterOption.All.display} value={defaultValue}>
            {YesNoFilterOption.All.display}
          </option>
          {isNullable && (
            <option key={YesNoFilterOption.Empty.display} value={emptyValue}>
              {YesNoFilterOption.Empty.display}
            </option>
          )}
          <option key={YesNoFilterOption.YesValue.display} value={yesValue}>
            {YesNoFilterOption.YesValue.display}
          </option>
          <option key={YesNoFilterOption.NoValue.display} value={noValue}>

...
const RightsTopNavMenu: FC = () => {
  ...
  }, [drWorkingOnSave, drWorkingOnRefresh, drWorkingOnOptimisation, drLinear]);
  ...
  function doRefresh() {
    ...
    loadChildsTreeDataAndChecks(rViewId, dtKey, key, true);
  }
    ...
    <Nav>
      ...
      <Nav className="mr-auto">
        <Button
          ...
          onClick={(e) => {
            e.preventDefault();
            if (changedRights.length > 0) setShowRefreshConfirmMessage(true);
            else doRefresh();
          }}
        >
        ...
        <ToggleButton
          ...
          onChange={(val) => {
            navigate(
              `/Rights/${val.target.checked ? "reverseView" : "normalView"}`
            );
          }}
        >
        ...
        <Button
          ...
          onClick={() => {
            ...
            const curRViewId = (
              rView !== undefined
                ? GetEnumFromString(RightsViewKind, rView)
            ...
            if (selectedChildDataType !== null && dtKey !== undefined) {
